...
import com.contactManagementBackend.contactManagementBackend.model.Contact;
import com.contactManagementBackend.contactManagementBackend.Repository.ContactRepository;
...
public class ContactController {
    ...
    public ResponseEntity<Contact> update(@PathVariable Long id, @RequestBody Contact updated) {
        return repository.findById(id)
                .map(existing -> {
                    logger.info("✏️ [EDIT] Updating contact ID {}: Old Title={}, New Title={}",
                            id,
                            existing.getTitle(),
                ...
                .orElseGet(() -> {
                    logger.warn("⚠️ [EDIT] Contact not found with ID={}", id);
    ...
    public void delete(@PathVariable Long id) {
        ...
        logger.info("🗑️ [DELETE] Contact deleted: ID={}", id);
    }
    ...
    public ResponseEntity<Contact> getContactById(@PathVariable Long id) {
        return repository.findById(id)
                ...
                .orElseGet(() -> {
                    logger.warn("⚠️ [GET] Contact not found with ID={}", id);
                    return ResponseEntity.notFound().build();
                });
    }
}
